...
mod tests {
    ...
    fn test2024() {
        ...
        test_case!(2024, 16, "79404", "451");
        test_case!(2024, 17, "6,5,4,7,1,6,0,3,1", "106086382266778");
        test_case!(2024, 18, "318", "56,29");
        test_case!(2024, 19, "300", "624802218898092");
        test_case!(2024, 20, "0", "0");
        test_case!(2024, 21, "0", "0");
        test_case!(2024, 22, "14691757043", "1831");
